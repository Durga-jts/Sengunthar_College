    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3">
              ...
              <!-- about area start -->
            <div class="col-lg-9" id="about-college">
