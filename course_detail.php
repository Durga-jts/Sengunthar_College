                        ...
                        <table class="table_class">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Candidates must have completed 10+2 with Physics, Chemistry, Biology/Mathematics, and English as core subjects.</td>
                                </tr>
                    ...
                    <div class="cs-content"> 
                        ...
                        <table class="table_class">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Eligibility Criteria</td>
                                    <td>Candidates must have completed 10+2 with Physics, Chemistry, Biology/Mathematics, and English as core subjects.<br>Minimum aggregate marks may vary, and specific requirements should be checked with the college.</td>
                                </tr>
                    ...
                    <div class="cs-content"> 
                        ...
                        <table class="table_class">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Eligibility Criteria</td>
                                    <td>Candidates should possess a Bachelor's degree in Pharmacy (B.Pharm) from a recognized institution.<br>Minimum aggregate marks may vary, and specific requirements should be checked with the college.</td>
                                </tr>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="sidebar">
                        ...
                        <div class="widget widget-instructor">
                            <h4 class="widget-title">Department Contact Info</h4>
                            <h4 >B.Pharm (Bachelor of Pharmacy)</h4><br>
                            <!-- <div class="instructor"> -->
                                <div class="post-author-info">
                                <ul>
                                    <li class="py-1">Prof. Dr. M. Surendra Kumar M.Pharm., Ph.D.,</li>
                                    <li class="py-1">Principal,</li>
                                    <li class="py-1">Senghundhar College Of Pharmacy</li>
                        ...
                        <!-- widget course start -->
                        <div class="widget widget-course mt-5">
