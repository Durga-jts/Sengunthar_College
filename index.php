...
<head>
    ...
    <title>Senghundhar College of Pharmacy</title>
    ...
    <style>
        ...
        @media screen and (max-width: 600px) {
            ...
            .slider_item .slider-content h3, .slider_item .slider-content h1 {
                font-size:15px;
            }
            .abt-right-thumb{
                margin-top: 5px;
...
<body>
    ...
    <div class="slider-area owl-carousel has-color">
        <div class="image-container">
            <img src="assets/images/Banner1.png" class="img_container" width="100">
        ...
        <div class="image-container">
            <img src="assets/images/Banner2.png" class="img_container" width="100">
                <div class="slider_item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 col-md-9">
                                <div class="slider-content">
                                    <h3>admission ‘ 2024</h3>
                                    <h1 style="color:#707070;"><span class="primary-color" >Your bright future</span> is Our Mission</h1>
                                    <p style="color:#707070;"> A leading institute in the city offers a B.Pharm course in Pharmacy. The course is available in Full Time mode.  </p>
        ...
        <div class="image-container">
            <img src="assets/images/Banner3.png" class="img_container" width="100">
                <div class="slider_item">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-8 col-md-9">
    ...
    <div class="container-fluid">
        ...
        <!-- <div class="row">
            <div class="col-lg-6">
                <div class="abt-right-thumb">
                    <div class="abt-rt-inner">
                        <img src="assets/images/Senghundhar_clg.jpg" class="abt-rt-image">
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="about-left-content">
                    <div class="section-title">
                        <!-- <span class="text-uppercase">mission & vision</span>
                        <h2>Our Mission</h2>
                        <p>Our mission includes designing cutting-edge research in the field of pharmaceutical sciences, drug development, and clinical pharmacy, contributing to advancements in the pharmaceutical industry. We are committed to providing pharmaceutical education and unlocking the hidden talents of students from rural backgrounds, recognizing the vital role they play in our nation's development.</p>
                        <h2>Our Vision</h2>
                        <p>Our vision is to be recognized as one of the premier institutes in Pharmacy Education, Research, and Pharmacy Practice at both the National and International levels. We strive to create an educational ecosystem that not only imparts knowledge but also nurtures a passion for continuous learning and innovation.</p>
...
<div class="container-fluid principal-message p-5 my-0">
    <div class="row">
...
<div class="course-area  pt--0  pb--50  mt-2 mt-5">
        <div class="container-fluid">
            <div class="row ">
                <div class="col-md-12 ">
                    <div class="section-title">
                        <h3 class="text-center">Why choose Senghundhar College of Pharmacy?</h3>
                    </div>
                </div>
            </div>
...
<!-- Course end -->
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-5 col-md-6 ml-4">
                <div class="section-title">
                    <span class="text-uppercase">Our College</span>
    ...
    <div class="container-fluid infrastructure d-flex justify-content-center  align-items-center">
        <div class="row infrastructure-row justify-content-center ">
            ...
            <div class="col-md-2 infras">
                <div class="infrastructure-text" onclick="window.location.href='facilities.php'"> &#10148; Library</div>     <!--129138-->
            </div>
            
            <div class="col-md-2 infras">
                <div class="infrastructure-text" onclick="window.location.href='facilities-auditorium.php'"> &#10148; Auditorium & Halls</div>
            </div>
            
            <div class="col-md-2 infras">
                <div class="infrastructure-text" onclick="window.location.href='facilities-machineroom.php'"> &#10148; Machine Room</div>
            </div>

            <div class="col-md-2 infras">
                <div class="infrastructure-text" onclick="window.location.href='facilitites-com-lab.php'"> &#10148; Lab</div>
            </div>

            <div class="col-md-2 infras">
                <div class="infrastructure-text" onclick="window.location.href='facilities-trasportation.php'"> &#10148; Transportation</div>
            </div>
    ...
    <!-- <div class="take-toure-area ptb--120 mt-5">
        <div class="container-fluid">
            <div class="row">
            ...
            <div class="video-area">
                <a class="expand-video" href="https://www.youtube.com/watch?v=YZWdIG7K8fE" target="_blank"><i class="fa fa-play"></i></a>
            </div>
        </div>
    </div> -->
    <!-- take toure area end -->
   ...
   <section class="container-fluid m-6 mt-5 mb-3">
        <div class="row">
            <div class="col-lg-5 col-md-6 ml-4">
                <div class="section-title">
                    <span class="text-uppercase">Our College's</span>
                    ...
                    <div class="row mb-30">
                                ...
                                <a href="activities&events.php" class="fancybox" rel="ligthbox" title="Two Days National Seminar on India as an Ideal Power: Role in G20 UNO & International Order - Organized by the Dept of Politics & Public Administration">
                                    ...
                                    <div class="row cont mt-1">
                                        <div class="col-md-12 text-justify">
                                            <h6>Two days international conference on current trends and future perspective of drug delivery systems organized by department of pharmaceutics </h6>
                                        </div>
                                    </div>
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="g-img" >
                                ...
                                <div class="row cont mt-1">
                                    <div class="col-md-12 text-justify">
                                        <h6>Pharmacy week celebration 2023 - Pharma Rally Theme: Pharmacist strengthening system</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="g-img">
                                    ...
                                    <div class="row cont  mt-1">
                                        <div class="col-md-12 text-justify">
                                            <h6>24 June 2022 - Winner JKKN College of Pharmacy in cultural competition</h6>
                                        </div>
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="g-img" style="height:30%;">
                                ...
                                <div class="row cont mt-1">
                                    <div class="col-md-12 text-center">
                                        <h6>Blood Donation Camp - 2023</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<!-- Activities and Events ends here-->
    ...
    <div class="container our-group ">
        ...
        <div class="card text-center">
            <a href="https://vkgsoft.co.in/sengunthar/index.html"  onclick="redirectToLink('https://vkgsoft.co.in/sengunthar/index.html')" target="_blank">
                ...
                <div class="card-body-clg">
                    <h5 class="card-title">Senghundhar Engineering College</h5>
                </div>
            </a>
        </div>
        ...
        <div class="card text-center card-border">
            <a href="https://smsartsandscience.com/" onclick="redirectToLink('https://smsartsandscience.com/')"  target="_blank" >
                ...
                <div class="card-body-clg">
                    <h5 class="card-title">Senghundhar Arts and Science College</h5>
                </div>
            </a>
        </div>
        ...
        <div class="card text-center">
            <a href="https://vkgsoft.co.in/scont.edu.in/index.php"  onclick="redirectToLink('https://vkgsoft.co.in/scont.edu.in/index.php')" target="_blank" >
                ...
                <div class="card-body-clg">
                    <h5 class="card-title">Senghundhar College Of Nursing</h5>
                </div>
            </a>
        </div>
      ...
      <!-- Branch 4 -->
        <div class="card text-center">
            <a href="https://vaaraahi.co.in/vaaraahi/" onclick="redirectToLink('https://vaaraahi.co.in/vaaraahi/)" target="_blank">
                ...
                <div class="card-body-clg">
                    <h5 class="card-title">Senghundhar College Of Pharmacy</h5>
                </div>
            </a>
        </div>
...
<script>
    function showBlog1() {
        ...
        window.location.href = `blog-details.html#blog1`;
    }
    function showBlog2() {
        // Redirect to blockdetails.html with the selected blog ID
        localStorage.setItem('selectedBlog', 'blog2');
        window.location.href = `blog-details.html#blog2`;
    }
    function showBlog3() {
        // Redirect to blockdetails.html with the selected blog ID
        localStorage.setItem('selectedBlog', 'blog3');
        window.location.href = `blog-details.html#blog3`;
    }

    //  Jan 10 -> Sengunthar college
