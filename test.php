        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="section-title">
                    ...
                    <form action="career_email.php"class="apply_form p-5 mt-3" id="careerForm" method="POST" name="careerForm">
                        ...
                        <div class="d-flex justify-content-center mt-3">
                            <button type="submit" class="btn btn-primary" id="nextStep" name="submit" onclick="validateForm()">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    ...
    function validateForm() {
        ...
        // Get the input elements inside the function
        var formData = {
    ...
    $.ajax({
        type: 'POST',
        url: 'career_email.php', // Replace with the actual path to your PHP script
        data: formData,
        contentType: false,
        processData: false,
        success: function (response) {
            ...
            if (data.success) {
                // If the email was sent successfully, show the popup
                showPopup();
            } else {
