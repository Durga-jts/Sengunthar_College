                ...
                <div class="faq_question_widget shadow_box">
                    <div class="widget_list">
                        <ul class="list_details" onclick="activateMenuItem(event)">
                            <li class="py-4"><a href="about.php" class="sidemenu_active">About College</a></li>
                        ...
                        <div class="row align-items-stretch">
                            <div class="col-lg-6">
                                <div class="about-left-content">
                                    ...
                                    <p class="text-justify mb-4">Senghundhar Charitable Trust, established in 1995, is dedicated to bringing out the hidden potential in students and shaping them into high-order entrepreneurs.</p>
                            ...
                            <div class="col-lg-6 h-25">
                                <div class="abt-right-thumb">
                                    <div class="abt-rt-inner">
                                        <img src="assets/images/about-trust.jpg" class="abt-rt-image">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="about-trust-area">
                            <div class="container-fluid">
                                ...
                                <div class="mission-section">
                                        ...
                                        <div>
                                            <p class="text-justify mb-4"> Encouraging a spirit of healthy competition, the trust aims to guide students in achieving a successful career while maintaining a contented and balanced life. In summary, Senghundhar Charitable Trust is dedicated to fostering entrepreneurship, contributing to national development, and promoting holistic development with a strong moral base among students. It envisions students who can successfully navigate both their careers and personal lives with a sense of fulfillment. The Trust offers scholarships to recognize and support students with exceptional academic achievements.</p>
                                        </div>
                                </div>
...
//     // Get the target content section ID from the clicked link
//     var contentId = event.target.getAttribute('href').substring(1);

//     // Hide all content sections
//     var allContentSections = document.querySelectorAll('.facilities-content_section .col-lg-9');
//     for (var i = 0; i < allContentSections.length; i++) {
//         allContentSections[i].style.display = 'none';
//     }
...
// // Add this code to hide other content sections initially
// document.addEventListener('DOMContentLoaded', function() {
//     var allContentSections = document.querySelectorAll('.facilities-content_section .col-lg-9');
//     for (var i = 1; i < allContentSections.length; i++) {
//         allContentSections[i].style.display = 'none';
//     }
// });
