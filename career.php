        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="section-title">
                    ...
                    <form class="apply_form p-5 mt-3" id="careerForm" method="POST" name="careerForm">
...
//         // Reset the form
//         var n = $("#popupContainer");
//         $("#contact-form").trigger('reset');

//         // Display the Thank You popup
//         var popupHtml = '<div class="mb-4 text-center">' +
//                             '<svg xmlns="http://www.w3.org/2000/svg" class="text-success" width="75" height="75" fill="currentColor" class="bi bi-check-circle-fill" viewBox="0 0 16 16">' +
//                                 '<path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"></path>' +
//                             '</svg>' +
//                         '</div>' +
...
//         n.html(popupHtml); // assuming n is the container where you want to display the message
//     },
//     error: function() {
//         // Handle errors here
//         n.html("<div class='alert alert-danger'><p>Error !!!</p></div>");
//     }
// });
