        ...
        <div class="footer-top has-color pt--50 pb--30">
            <div class="container-fluid">
                <div class="row ml-4">
                    ...
                    <div class="col-md-4">
                        <div class="widget widget-company">
                            <!-- <a href="index.html" style="width:40%;margin-left:-8%;"><img src="assets/images/logo1.png" alt="image"></a> -->
                            <div class="addr">
                                <div class="address">
                                    <h4 class="fwidget-title mb-5 pb-3 primary-color">Contact Us</h4>
                                    <p class="text-justify" style="font-weight:bold; font-size:18px;"><i class="fa fa-map-marker mr-2"></i>Senghundhar College of Pharmacy</p>
                                    <p>Kumaramangalam Post, Tiruchengode, Namakkal Dt. 637205</p>
                                </div>
                                <div class="address">
                                    <!-- <h6>PHONE NUMBER</h6> -->
                                    <p><i class="fa fa-mobile mr-2"></i>+91 9367653355 / 8825707617</p>
                                </div>
                                <div class="address">
                                    <!-- <h6>EMAIL ADDRESS</h6> -->
                                ...
                                <div class="address">
                                    <!-- <h6>WEBSITE LINK</h6> -->
                                    <p><i class="fa fa-globe mr-2"></i> www.senghundharpharmacycollege.org </p>         <!--<a href="http://vaaraahi.co.in" target="_blank">vaaraahi.co.in</a>-->
                                </div>
                ...
                <div class="footer-bottom">
                    <p>Copyrights ©2024 <span><a class="primary-color" href="" target="_blank"></a> </span> - <span> Senghundhar College of Pharmacy, All Rights Reserved</span>.  Developed by <a href="https://www.vaaraahitech.com/" target="_blank" class="ml-3"><img src="assets/images/vaarahi-logo.png" alt="Vaaraahi Logo"></a></p>
